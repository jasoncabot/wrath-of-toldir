...
export function unionToUpdate(
  type: Update,
  accessor: (obj:AttackEvent|JoinEvent|LeaveEvent|MapChangedEvent|MapJoinedEvent|MoveEvent) => AttackEvent|JoinEvent|LeaveEvent|MapChangedEvent|MapJoinedEvent|MoveEvent|null
): AttackEvent|JoinEvent|LeaveEvent|MapChangedEvent|MapJoinedEvent|MoveEvent|null {
  switch(Update[type]) {
...
export function unionListToUpdate(
  type: Update, 
  accessor: (index: number, obj:AttackEvent|JoinEvent|LeaveEvent|MapChangedEvent|MapJoinedEvent|MoveEvent) => AttackEvent|JoinEvent|LeaveEvent|MapChangedEvent|MapJoinedEvent|MoveEvent|null, 
  index: number
): AttackEvent|JoinEvent|LeaveEvent|MapChangedEvent|MapJoinedEvent|MoveEvent|null {
  switch(Update[type]) {
    case 'NONE': return null; 
