...
export class ItemCollectedEvent {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
__init(i:number, bb:flatbuffers.ByteBuffer):ItemCollectedEvent {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsItemCollectedEvent(bb:flatbuffers.ByteBuffer, obj?:ItemCollectedEvent):ItemCollectedEvent {
  return (obj || new ItemCollectedEvent()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsItemCollectedEvent(bb:flatbuffers.ByteBuffer, obj?:ItemCollectedEvent):ItemCollectedEvent {
